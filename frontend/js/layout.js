...
const SOCIAL_LINKS = [
  {
    ...
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 21v-7.5h2.4l.4-3h-2.8V8.6c0-.9.2-1.5 1.5-1.5h1.4V4.2c-.3 0-1.3-.1-2.5-.1-2.5 0-4.2 1.5-4.2 4.3v2.1H7v3h2.7V21h3.8z"/></svg>`,
  },
  {
    label: "Instagram",
